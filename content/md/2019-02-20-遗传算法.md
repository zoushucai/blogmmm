...
| 名称                         | 具体做法                                                     | 特点         | 适用编码 |
| ---------------------------- | ------------------------------------------------------------ | ------------ | -------- |
| 单点交叉<br>（符号编码常用） | ![yichuan01](yichuan01-0391034.png)                          | 标准遗传算法 | 符号编码 |
| 两点(三点)交叉               | ![yichuan02](yichuan02-0391036.png)<br>![yichuan03](yichuan03-0391035.png) | 使用较多     | 符号编码 |
| 均匀交叉                     | ![yichuan04](yichuan04-0391035.png)                          | 无           | 符号编码 |
...
​	具体算法 :    $x_1$:  $17.2042 = \log_2^{(12.1-(-3.0))\cdot10^4+1} \le 15 < \log_2^{(12.1-(-3.0))\cdot10^4}+1 =18.2042$, 故取18
...
算法程序链接（二进制与实数编码）：[遗传算法matlab](https://gitee.com/zscqsmy/blogimg/raw/master/img/2020091416遗传算法matlab.zip)
